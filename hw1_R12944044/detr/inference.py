...
state_dict = torch.load(
    "/local/tomlord1122/1121-CVPDL/detr/output/latest.pth", map_location="cpu"
)
...
testImg = get_filenames_in_directory(
    "/local/tomlord1122/1121-CVPDL/detr/hw1_dataset/val2017"
)


im = Image.open(
    "/local/tomlord1122/1121-CVPDL/detr/hw1_dataset/val2017/IMG_2277_jpeg_jpg.rf.86c72d6192da48d941ffa957f4780665.jpg"
)
...
def resJson(testImg):
    ...
    for i in range(len(testImg)):  # iterate 每一張test img
        im = Image.open(
            f"/local/tomlord1122/1121-CVPDL/detr/hw1_dataset/val2017/{testImg[i]}"
        )
        scores, boxes = detect(im, detr, transform)
...
def plot_results(pil_img, prob, boxes):
    ...
    plt.axis("off")
    plt.savefig("/local/tomlord1122/test.png")
    plt.show()
